...
$(document).ready(function () {
    ...
    $('#search').on('input', function () {
        ...
        $.ajax({
            url: "https://www.datastory.ch/constitutions-time-machine/boussole/ajax/autocomplete",
            data: {
                term: $this.value
            }
            ...
            if (result.length > 0) {
                ...
                for (i = 0; i < result.length; i++) {
                    ...
                    b.innerHTML = "<b>Article " + res.nomArticle + "</b>";
                    ...
                    b.addEventListener("click", function (e) {
                        window.location.href = "http://www.datastory.ch/constitutions-time-machine/boussole/article/details/" + res.id;
